    ...
    function getUrl($type = 'post'): string
{
    switch ($type) {
        case 'post':
            ...
            $selectedUrl = $this->faker->randomElement($urls);
            echo "Selected URL for post: $selectedUrl\n";
            return $selectedUrl;
        ...
        case 'reels':
            ...
            $selectedUrl = $this->faker->randomElement($urls);
            echo "Selected URL for reels: $selectedUrl\n";
            return $selectedUrl;

        default:
            echo "Default case hit with type: $type\n";
